...
import type { SignDataRequestEvent, SignDataRequestEventPreview } from '../models/bridge/SignDataRequestEvent';
 ...
 */
export class SignDataRequestEventMapper extends Mapper<EventSignDataRequest, SignDataRequestEvent> {
