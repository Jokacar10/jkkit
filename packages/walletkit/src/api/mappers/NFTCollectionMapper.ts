 ...
 */
export class NFTCollectionMapper extends Mapper<NftCollection, NFTCollection | undefined> {
    ...
    map(input: NftCollection): NFTCollection | undefined {
        ...
        const ownerAddress = input.ownerAddress ? this.addressMapper.map(input.ownerAddress) : undefined;
