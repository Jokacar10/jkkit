...
import type { TransactionRequestEvent, TransactionRequestEventPreview } from '../models/bridge/TransactionRequestEvent';
 ...
 */
export class TransactionRequestEventMapper extends Mapper<EventTransactionRequest, TransactionRequestEvent> {
