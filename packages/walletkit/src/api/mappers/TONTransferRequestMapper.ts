 ...
 */
export class TONTransferRequestMapper extends Mapper<TONTransferRequest, TonTransferParams> {
    ...
    map(input: TONTransferRequest): TonTransferParams {
        const base = {
            ...
            mode: input.mode ? (this.sendModeMapper.reverse(input.mode) as SendMode) : undefined,
